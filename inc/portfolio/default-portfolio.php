...
switch($bsdfw['opt-projects-display']) {
	case '4' : $projectDisplayTypeClass = 'bsdpf-display-display'; break;
}

?>

<!-- Start Projects Grid -->
<ul id="bsdpf-grid" class="large-block-grid-3 medium-block-grid-2 small-block-grid-1">
...
switch($portfolio_type) {
	...
	?>
	<li class="bsdpf-post animated slow fadeInRight grayscale lazy">
