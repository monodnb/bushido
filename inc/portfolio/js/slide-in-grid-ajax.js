		...
		$('body').on("click", '.bsdpf-post-icons > a', function (e) {
			...
			function closeProject() {
				...
				setTimeout(function () {
					...
					bsdThisAjax.removeClass('inflate');
					bsdThisAjaxClose.removeClass('slide-in-bottom');
				}, 600);
			}
			...
			function hideLoader() {
				if (bsdThisAjaxInfo.children().length > 0) {
					...
					bsdThisAjax.addClass('inflate');
					//bsdThisAjaxClose.addClass('slide-in-bottom');
